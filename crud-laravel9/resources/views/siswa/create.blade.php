...
<head>
    ...
    <title>Tambah Data siswa - Penerimaan siswa Baru</title>
                    ...
                    <div class="card-body">
                        <form action="{{ route('siswa.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="int" class="form-control @error('nisn') is-invalid @enderror"
                            ...
                            <div class="form-group">
                                ...
                                <input type="varchar2" class="form-control @error('Nama_siswa') is-invalid @enderror"
                                    name="Nama_siswa" placeholder="Nama_siswa">
                            ...
                            <div class="form-group">
                                ...
                                <input type="varchar2" class="form-control @error('tempat_lahir') is-invalid @enderror"
                                    name="Tempat_lahir" placeholder="tempat_lahir">
                                <!-- error message untuk tempat_lahir -->
                                @error('nisn')
                                <div class="alert alert-danger mt-2">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="int" class="form-control @error('kelas') is-invalid @enderror"

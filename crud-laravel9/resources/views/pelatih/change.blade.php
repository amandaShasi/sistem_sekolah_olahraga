              ...
              <form action="{{ route('pelatih.update', $data->id_pelatih) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputPassword1">Nama Pelatih</label>
                    <input type="text" class="form-control" name  ="Nama_pelatih" value="{{$data->Nama_pelatih}}" id="exampleInputPassword1" placeholder="Nama">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Jenis Kelamin</label>
                    <input type="date" class="form-control" name="Jenis_kelamin" value="{{$data->Jenis_kelamin}}" id="exampleInputPassword1" placeholder="Nama">
                  </div>
                      <div class="form-group">

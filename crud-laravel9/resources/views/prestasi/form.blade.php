            ...
            <div class="card card-primary">
              ...
              <form action="{{ route('prestasi.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="exampleInputPassword1">Jenis Prestasi</label>
                    <input type="text" class="form-control" name="jenis_prestasi" id="exampleInputPassword1" placeholder="Jenis Prestasi">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Waktu</label>
                    <input type="datetime-local" class="form-control" name="waktu" id="exampleInputPassword1" placeholder="Waktu">
                  </div>
                  {{-- <div class="form-group">

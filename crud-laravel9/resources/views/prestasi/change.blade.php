              ...
              <form action="{{ route('prestasi.update', $data->id_prestasi) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="jenis_prestasi" value="{{$data->jenis_prestasi}}" id="jenisPrestasi" placeholder="Nama">
                    </div>
                    <div class="form-group">
                        <label for="waktu">Waktu</label>
                        <input type="datetime-local" class="form-control" name="waktu" value="{{$data->waktu}}" id="waktu" placeholder="Waktu">
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                            <!-- select -->
                            <div class="form-group">
                                <label for="cabangOlahraga">Nama</label>

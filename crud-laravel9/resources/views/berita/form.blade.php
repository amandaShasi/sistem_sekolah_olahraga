              ...
              <form action="{{ route('berita.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="Deskripsi" id="exampleInputPassword1" placeholder="Nama">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Waktu</label>
                    <input type="datetime-local" class="form-control" name="Waktu" id="exampleInputPassword1" placeholder="Nama">
                  </div>
                  <div class="form-group">
